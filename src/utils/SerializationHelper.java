 ...
 * 
 *         Serialize and deserialize any type of object that implements the
...
public class SerializationHelper {
	 ...
	 * object it is deserializing. It will work for *anything* that can be
	 * deserialized.
	 * 
	 ...
	 * @return The deserialized object NOTE: This would be called like so:
	 *         SerializationHelper.deserialize(Object.class, path) where
	 *         "Object.class" is whatever object type you're deserializing, e.g.
	 *         "vehicle.Car.class" to deserialize the vehicle.Car
	 */
	 ...
	 * 
	 * @param type     The object type, passed as, for example, Object.class
	 * @param obj      The object to be saved, will be up-cast to the proper type
	 *                 before saving
